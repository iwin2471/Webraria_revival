...
terrainTileSet[(1, 6)].src =
  "Resource/Tiles/liquid/water surface opacity 90.png";
terrainTileSet[(1, 7)] = new Image();
terrainTileSet[(1, 7)].src =
  "Resource/Tiles/liquid/water surface opacity 95.png";
...
for(let terrainTile of terrainTileSet) {
    terrainTile.onload = () => {
        loadedCount++;
    }
}
...
function checkLoaded() {
    return loadedCount == terrainTileSet.length()
}